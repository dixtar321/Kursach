...
void start() { 
	...
	cout << "¬ведЄнные слова:" << endl;
	//input(Array);
	///*
	char words[]= "C:/Users/alex_/OneDrive/–абочий стол/«адани€/»нформатика/семак 3/ урсова€/CrissCross/words.txt";
	int correct_words_input = input_from_file(Array, words);
	if (correct_words_input == -1) {
		cout << "ћаловато слов, нужно добавить ещЄ" << endl;
		return;
	}
